    ...
    */ 
	public function __construct() 
	{
	    ...
	    $this->load->model(array( 
            'dashboard_doctor/sms/sms_model',
            'dashboard_model'
        ));	
    }
    ...
    public function new_sms()
    {
        ...
        $data['content'] = $this->load->view('dashboard_doctor/sms/form', $data, true);
    ...
    { 
        ...
        redirect('dashboard_doctor/sms/sms/new_sms');
    }  
    ...
    { 
        ...
        #pagination starts
        #
        $config["base_url"] = base_url('dashboard_doctor/sms/sms/sms_list');
        ...
        $data['content'] = $this->load->view('dashboard_doctor/sms/list', $data, true);
        $data['count']    = $this->dashboard_model->getAlertCount(); 
