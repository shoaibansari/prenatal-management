...
class Dashboard extends CI_Controller {
    ...
    {   
        ...
        if ($this->form_validation->run() === true) {
            ...
            $role = $this->dashboard_model->check_user_role($postData);
            ...
            if ($check_user->num_rows() === 1) {
                ...
                $this->session->set_userdata([
                    'isLogIn'   => true,
                    'user_id' => (($role==10)?$check_user->row()->id:$check_user->row()->user_id),
                    'patient_id' => (($role==10)?$check_user->row()->patient_id:null),
                    'email'     => $check_user->row()->email,
                    'fullname'  => $check_user->row()->firstname.' '.$check_user->row()->lastname,
                    'user_role' => (($role==10)?10:$check_user->row()->user_role),
    ...
    {   
        ...
        switch ($user_role) {
            ...
            case 10:
                ...
                break; 
            case 11:    
                    redirect('dashboard_midwife/home');
                break; 
