...
class Sms extends CI_Controller {
    ...
    */ 
	public function __construct() 
	{
	    ...
	    $this->load->model('dashboard_pharmacist/sms/sms_model');	
    }
    ...
    public function new_sms()
    {
        ...
        $data['content'] = $this->load->view('dashboard_pharmacist/sms/form', $data, true);
    ...
    { 
        ...
        redirect('dashboard_pharmacist/sms/sms/new_sms');
    }  
    ...
    { 
        ...
        #pagination starts
        #
        $config["base_url"] = base_url('dashboard_pharmacist/sms/sms/sms_list');
        ...
        $data['content'] = $this->load->view('dashboard_pharmacist/sms/list', $data, true);
        $this->load->view('dashboard_pharmacist/main_wrapper',$data);
    } 
}
