...
class Home extends CI_Controller {
    ...
    public function index()
    {
        ...
        $data['content'] = $this->load->view('dashboard_midwife/home/dashboard',$data,true);
    ...
    {  
        ...
        $data['content'] = $this->load->view('dashboard_midwife/home/profile', $data, true);
        $data['count']    = $this->dashboard_model->getAlertCount(); 
    ...
    public function form()
    {
        ...
        $this->form_validation->set_rules('password', display('password'),'required|max_length[32]|md5|min_length[8]');
        ...
        if ($this->form_validation->run() === true) {
            ...
            redirect('dashboard_midwife/home/form/');

        } else {
            $user_id = $this->session->userdata('user_id');
            $data['department_list'] = $this->home_model->department_list(); 
            $data['doctor'] = $this->home_model->profile($user_id); 
            $data['content'] = $this->load->view('dashboard_midwife/home/profile_form',$data,true);
            $data['count']    = $this->dashboard_model->getAlertCount(); 
