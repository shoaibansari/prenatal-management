...
class Report extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model(array(
			'dashboard_midwife/bed_manager/report_model', 
		));
	...
	{ 
		...
		$data['content'] = $this->load->view('dashboard_midwife/bed_manager/report',$data,true);
	...
	{ 
		...
		$data['content'] = $this->load->view('dashboard_midwife/bed_manager/report_details',$data,true);
		$this->load->view('dashboard_midwife/main_wrapper',$data);
	} 
