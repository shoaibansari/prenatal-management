...
class Bed_assign extends CI_Controller {
    ...
    public function __construct()
    {
        ...
        $this->load->model(array(
            'dashboard_midwife/bed_manager/bed_model',
            'dashboard_midwife/bed_manager/bed_assign_model'
        ));
    ...
    public function index()
    {
        ...
        $data['content'] = $this->load->view('dashboard_midwife/bed_manager/bedAssign_view',$data,true);
