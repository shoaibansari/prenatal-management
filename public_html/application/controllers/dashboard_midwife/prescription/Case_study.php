...
class Case_study extends CI_Controller {
	...
	public function index()
	{
		...
		$data['content'] = $this->load->view('dashboard_midwife/prescription/case_study',$data,true);
 	...
 	public function create()
	{
		...
		if ($this->form_validation->run()) {
			...
			if (empty($postData['id'])) {
				...
				redirect('dashboard_midwife/prescription/case_study/create');
			} else {
				...
				redirect('dashboard_midwife/prescription/case_study/edit/'.$postData['id']);
			}

		} else {
			$data['content'] = $this->load->view('dashboard_midwife/prescription/case_study_form',$data,true);
			$data['count']    = $this->dashboard_model->getAlertCount(); 
	...
	public function delete($id = null) 
	{
		...
		redirect('dashboard_midwife/prescription/case_study');
	}
