...
class Prescription extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model(array(
			'dashboard_midwife/prescription/insurance_model',
			'dashboard_midwife/prescription/medicine_model',
			'dashboard_midwife/prescription/case_study_model',
			'dashboard_doctor/doctor/doctor_model',
			'dashboard_midwife/prescription/prescription_model',
			'dashboard_model'
		));
	...
	public function index()
	{
		...
		$data['content'] = $this->load->view('dashboard_midwife/prescription/prescription',$data,true);
	...
	{   
		...
		if ($this->form_validation->run() === true) 
		{
			...
			redirect('dashboard_midwife/prescription/prescription/create');
			...
			$data['content'] = $this->load->view('dashboard_midwife/prescription/prescription_form',$data,true);
			$data['count']    = $this->dashboard_model->getAlertCount(); 
	...
	public function view($id = null) 
	{
		...
		$data['insurance_list'] = $this->insurance_model->insurance_list();
		$data['medicine_list'] = $this->medicine_model->medicine_list();
		$data['content'] = $this->load->view('dashboard_midwife/prescription/prescription_view',$data,true)
		;
		$data['count']    = $this->dashboard_model->getAlertCount(); 
	...
	{ 
		...
		if ($this->form_validation->run() === true) 
		{
			...
			redirect('dashboard_midwife/prescription/prescription/edit/'.$id);
			...
			$data['medicine_list'] = $this->medicine_model->medicine_list();
			$data['website'] = $this->prescription_model->website();
			$data['content'] = $this->load->view('dashboard_midwife/prescription/prescription_edit',$data,true);
			$data['count']    = $this->dashboard_model->getAlertCount(); 
	...
	public function delete($id = null) 
	{
		...
		redirect('dashboard_midwife/prescription/prescription');
	}
