...
class Patient extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model(array(
			'dashboard_midwife/patient/patient_model',
			'dashboard_midwife/patient/document_model',
			'doctor_model',
			'dashboard_model'
		));
	...
	{  
		...
		$data['content'] = $this->load->view('dashboard_midwife/patient/patient',$data,true);
	...
	public function create()
	{
		...
		if ($this->form_validation->run() === true) {
	      ...
	      //           }
				...
				redirect('dashboard_midwife/patient/patient/profile/' . $insert_id);
			} else {
				...
				redirect('dashboard_midwife/patient/patient/edit/'.$postData['id']);
			}

		} else {
			$data['content'] = $this->load->view('dashboard_midwife/patient/patient_form',$data,true);
			$data['count']    = $this->dashboard_model->getAlertCount(); 
	...
	{ 
		...
		$data['content'] = $this->load->view('dashboard_midwife/patient/patient_profile',$data,true);
		$data['count']    = $this->dashboard_model->getAlertCount(); 
    ...
    */
	...
	{ 
		...
		$data['content'] = $this->load->view('dashboard_midwife/patient/document',$data,true);
		$data['count']    = $this->dashboard_model->getAlertCount(); 
    ...
    {  
        ...
        if ($this->form_validation->run() === true) { 
            ...
            redirect('dashboard_midwife/patient/patient/document_form');
        } else {
            $data['doctor_list'] = $this->doctor_model->doctor_list(); 
            $data['content'] = $this->load->view('dashboard_midwife/patient/document_form',$data,true);
			$data['count']    = $this->dashboard_model->getAlertCount(); 
