...
class Appointment extends CI_Controller {
    ...
    public function __construct()
    {
        ...
        $this->load->model(array(
            'dashboard_midwife/appointment/appointment_model',
            'dashboard_midwife/appointment/department_model',
            'dashboard_model'
        ));
    ...
    { 
        ...
        /* ------------------------------- */
        $data['appointments'] = $this->appointment_model->read_by_nurse($this->session->userdata('user_id'));
        $data['content'] = $this->load->view('dashboard_midwife/appointment/appointment',$data,true);
    ...
    public function create()
    {
        ...
        if ($this->form_validation->run() === true && $check_patient_id->status === true && $check_appointment_exists === true) {
            ...
            redirect('dashboard_midwife/appointment/appointment/view/'.$postData['appointment_id']);

        } else {
            $data['department_list'] = $this->department_model->department_list(); 
            $data['content'] = $this->load->view('dashboard_midwife/appointment/appointment_form',$data,true);
            $data['count']    = $this->dashboard_model->getAlertCount(); 
            $this->load->view('dashboard_midwife/main_wrapper',$data);
        } 
    }
      ...
      {  
        ...
        $data['content'] = $this->load->view('dashboard_midwife/appointment/appointment_view',$data,true);
        $data['count']    = $this->dashboard_model->getAlertCount(); 
        $this->load->view('dashboard_midwife/main_wrapper',$data);
      } 
