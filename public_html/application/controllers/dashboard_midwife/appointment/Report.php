...
class Report extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model(array(
			'dashboard_midwife/doctor/doctor_model', 
			'dashboard_midwife/appointment/report_model',
			'dashboard_model' 
		));
	...
	{    
		...
		$data['content'] = $this->load->view('dashboard_midwife/appointment/report_assign_by_me',$data,true);
	...
	{  
		...
		$data['content'] = $this->load->view('dashboard_midwife/appointment/report_assign_to_me',$data,true)
		;
		$data['count']    = $this->dashboard_model->getAlertCount(); 
