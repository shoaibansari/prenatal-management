    ...
    */ 
	public function __construct() 
	{
	    ...
	    $this->load->model(array( 
            'dashboard_midwife/sms/sms_model',
            'dashboard_model'
        ));	
    }
    ...
    public function new_sms()
    {
        ...
        $data['content'] = $this->load->view('dashboard_midwife/sms/form', $data, true);
    ...
    { 
        ...
        redirect('dashboard_midwife/sms/sms/new_sms');
    }  
    ...
    { 
        ...
        #pagination starts
        #
        $config["base_url"] = base_url('dashboard_midwife/sms/sms/sms_list');
        ...
        $data['content'] = $this->load->view('dashboard_midwife/sms/list', $data, true);
        $data['count']    = $this->dashboard_model->getAlertCount(); 
