...
class Message extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model(array(
            'dashboard_midwife/messages/message_model' ,
            'dashboard_model'
		));
    ...
    public function index()
    {
        ...
        $data['content']  = $this->load->view('dashboard_midwife/messages/inbox' ,$data,true);
	...
	public function sent()
	{
		...
		$data['content'] = $this->load->view('dashboard_midwife/messages/sent' ,$data,true);
        $data['count']    = $this->dashboard_model->getAlertCount(); 
    ...
    {  
        ...
        $data['content'] = $this->load->view('dashboard_midwife/messages/inbox_information',$data,true);
        $data['count']    = $this->dashboard_model->getAlertCount(); 
    ...
    {  
        ...
        $data['content'] = $this->load->view('dashboard_midwife/messages/sent_information',$data,true);
        $data['count']    = $this->dashboard_model->getAlertCount(); 
    ...
    { 
        ...
        if ($this->form_validation->run() === true) { 
            ...
            redirect('dashboard_midwife/messages/message/new_message');
        } else {
            $data['title'] = display('new_message');
            $data['user_list'] = $this->message_model->user_list($user_id);
            $data['content'] = $this->load->view('dashboard_midwife/messages/new_message',$data,true);
            $data['count']    = $this->dashboard_model->getAlertCount(); 
