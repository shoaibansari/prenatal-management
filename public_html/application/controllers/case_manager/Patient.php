...
class Patient extends CI_Controller {
	...
	public function form($id = null)
	{
		...
		$this->form_validation->set_rules('hospital_name', display('hospital_name'),'max_length[255]|regex_match[/^[A-Z a-z \-]+$/]');
		$this->form_validation->set_rules('doctor_name', display('doctor_name'),'max_length[255]|regex_match[/^[A-Z a-z \-]+$/]');
