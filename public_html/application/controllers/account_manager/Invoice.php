...
class Invoice extends CI_Controller {
	...
	{  
		...
		$this->form_validation->set_rules('quantity[]', display('quantity'),'required|trim|numeric');
		$this->form_validation->set_rules('price[]', display('price'),'required|trim|numeric');
		$this->form_validation->set_rules('total', display('total'),'required|trim|numeric');
		$this->form_validation->set_rules('vat', display('vat'),'required|trim|numeric');
		$this->form_validation->set_rules('discount', display('discount'),'required|trim|numeric');
		$this->form_validation->set_rules('grand_total', display('grand_total'),'required|trim|numeric');
		$this->form_validation->set_rules('paid', display('paid'),'required|trim|numeric');
		$this->form_validation->set_rules('due', display('due'),'required|trim|numeric');
