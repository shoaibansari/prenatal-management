    ...
    */ 
	public function __construct() 
	{
	    ...
	    $this->load->model(array( 
            'dashboard_representative/sms/sms_model', 
            'dashboard_model'
        ) );	
    }
    ...
    public function new_sms()
    {
        ...
        $data['content'] = $this->load->view('dashboard_representative/sms/form', $data, true);
    ...
    { 
        ...
        redirect('dashboard_representative/sms/sms/new_sms');
    }  
    ...
    { 
        ...
        #pagination starts
        #
        $config["base_url"] = base_url('dashboard_representative/sms/sms/sms_list');
        ...
        $data['content'] = $this->load->view('dashboard_representative/sms/list', $data, true);
        $data['count']    = $this->dashboard_model->getAlertCount(); 
        $this->load->view('dashboard_representative/main_wrapper',$data);
    } 
}
