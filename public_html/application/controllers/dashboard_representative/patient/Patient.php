...
class Patient extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model(array(
			...
			'dashboard_representative/patient/document_model',
			'doctor_model',
			'dashboard_model'
		));
	...
	public function create()
	{
		...
		if ($this->form_validation->run() === true) {
	      ...
	      //           }
				...
				redirect('dashboard_representative/patient/patient/profile/' . $insert_id);
			} else {
				...
				redirect('dashboard_representative/patient/patient/edit/'.$postData['id']);
			}
    ...
    */
	...
	{ 
		...
		$data['content'] = $this->load->view('dashboard_representative/patient/document',$data,true);
		$data['count']    = $this->dashboard_model->getAlertCount(); 
		$this->load->view('dashboard_representative/main_wrapper',$data);
	} 
    ...
    {  
        ...
        if ($this->form_validation->run() === true) { 
            ...
            redirect('dashboard_representative/patient/patient/document_form');
        } else {
            $data['doctor_list'] = $this->doctor_model->doctor_list(); 
            $data['content'] = $this->load->view('dashboard_representative/patient/document_form',$data,true);
            $data['count']    = $this->dashboard_model->getAlertCount(); 
            $this->load->view('dashboard_representative/main_wrapper',$data);
        }  
    } 
