...
class Prescription extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model(array(
			'dashboard_nurse/prescription/insurance_model',
			'dashboard_nurse/prescription/medicine_model',
			'dashboard_nurse/prescription/case_study_model',
			'dashboard_doctor/doctor/doctor_model',
			'dashboard_nurse/prescription/prescription_model',
			'dashboard_model'
		));
	...
	public function index()
	{
		...
		$data['content'] = $this->load->view('dashboard_nurse/prescription/prescription',$data,true);
	...
	{   
		...
		if ($this->form_validation->run() === true) 
		{
			...
			redirect('dashboard_nurse/prescription/prescription/create');
			...
			$data['content'] = $this->load->view('dashboard_nurse/prescription/prescription_form',$data,true);
			$data['count']    = $this->dashboard_model->getAlertCount(); 
			$this->load->view('dashboard_nurse/main_wrapper',$data);
		} 
	}
	...
	public function view($id = null) 
	{
		...
		$data['insurance_list'] = $this->insurance_model->insurance_list();
		$data['medicine_list'] = $this->medicine_model->medicine_list();
		$data['content'] = $this->load->view('dashboard_nurse/prescription/prescription_view',$data,true);
		$data['count']    = $this->dashboard_model->getAlertCount(); 
		$this->load->view('dashboard_nurse/main_wrapper',$data);
	}
	...
	{ 
		...
		if ($this->form_validation->run() === true) 
		{
			...
			redirect('dashboard_nurse/prescription/prescription/edit/'.$id);
			...
			$data['medicine_list'] = $this->medicine_model->medicine_list();
			$data['website'] = $this->prescription_model->website();
			$data['content'] = $this->load->view('dashboard_nurse/prescription/prescription_edit',$data,true);
			$data['count']    = $this->dashboard_model->getAlertCount(); 
			$this->load->view('dashboard_nurse/main_wrapper',$data);
		} 		
	}
	...
	public function delete($id = null) 
	{
		...
		redirect('dashboard_nurse/prescription/prescription');
	}
