...
class Case_study extends CI_Controller {
	...
	public function index()
	{
		...
		$data['content'] = $this->load->view('dashboard_nurse/prescription/case_study',$data,true);
 	...
 	public function create()
	{
		...
		if ($this->form_validation->run()) {
			...
			if (empty($postData['id'])) {
				...
				redirect('dashboard_nurse/prescription/case_study/create');
			} else {
				...
				redirect('dashboard_nurse/prescription/case_study/edit/'.$postData['id']);
			}

		} else {
			$data['content'] = $this->load->view('dashboard_nurse/prescription/case_study_form',$data,true);
			$data['count']    = $this->dashboard_model->getAlertCount(); 
			$this->load->view('dashboard_nurse/main_wrapper',$data);
		} 
	}
	...
	public function delete($id = null) 
	{
		...
		redirect('dashboard_nurse/prescription/case_study');
	}
