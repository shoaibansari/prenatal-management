...
class Schedule extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model(array(
			'dashboard_nurse/schedule/schedule_model',
	...
	public function index()
	{
		...
		$data['content'] = $this->load->view('dashboard_nurse/schedule/view',$data,true);
	...
	{  
		...
		if ($this->form_validation->run() === true) {
			...
			if (empty($postData['schedule_id'])) {
				...
				redirect('dashboard_nurse/schedule/schedule/create');
			} else {
				...
				redirect('dashboard_nurse/schedule/schedule/edit/'.$postData['schedule_id']);
			}

		} else {
			$data['doctor_list'] = $this->doctor_model->doctor_list();
			$data['content'] = $this->load->view('dashboard_nurse/schedule/form',$data,true);
			$data['count']    = $this->dashboard_model->getAlertCount(); 
			$this->load->view('dashboard_nurse/main_wrapper',$data);
		}
	}
	...
	{ 
		...
		redirect('dashboard_nurse/schedule/schedule/');
	}
