...
class Sms extends CI_Controller {
    ...
    */ 
    ...
    public function new_sms()
    {
        ...
        $data['content'] = $this->load->view('dashboard_nurse/sms/form', $data, true);
    ...
    { 
        ...
        redirect('dashboard_nurse/sms/sms/new_sms');
    }  
    ...
    { 
        ...
        #pagination starts
        #
        $config["base_url"] = base_url('dashboard_nurse/sms/sms/sms_list');
        ...
        $data['content'] = $this->load->view('dashboard_nurse/sms/list', $data, true);
        $data['count']    = $this->dashboard_model->getAlertCount(); 
        $this->load->view('dashboard_nurse/main_wrapper',$data);
    } 
}
