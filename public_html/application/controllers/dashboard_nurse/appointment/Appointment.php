...
class Appointment extends CI_Controller {
    ...
    public function __construct()
    {
        ...
        $this->load->model(array(
            'dashboard_nurse/appointment/appointment_model',
            'dashboard_nurse/appointment/department_model',
            'dashboard_model'
        ));
    ...
    { 
        ...
        $data['content'] = $this->load->view('dashboard_nurse/appointment/appointment',$data,true);
    ...
    public function create()
    {
        ...
        if ($this->form_validation->run() === true && $check_patient_id->status === true && $check_appointment_exists === true) {
            ...
            redirect('dashboard_nurse/appointment/appointment/view/'.$postData['appointment_id']);

        } else {
            $data['department_list'] = $this->department_model->department_list(); 
            $data['content'] = $this->load->view('dashboard_nurse/appointment/appointment_form',$data,true);
            $data['count']    = $this->dashboard_model->getAlertCount(); 
            $this->load->view('dashboard_nurse/main_wrapper',$data);
        } 
    }
      ...
      {  
        ...
        $data['content'] = $this->load->view('dashboard_nurse/appointment/appointment_view',$data,true);
        $data['count']    = $this->dashboard_model->getAlertCount(); 
        $this->load->view('dashboard_nurse/main_wrapper',$data);
      } 
