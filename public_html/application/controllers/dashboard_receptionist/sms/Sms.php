    ...
    */ 
	public function __construct() 
	{
	    ...
	    $this->load->model(array( 
            'dashboard_receptionist/sms/sms_model',
            'dashboard_model'
        ));	
    }
    ...
    public function new_sms()
    {
        ...
        $data['content'] = $this->load->view('dashboard_receptionist/sms/form', $data, true);
    ...
    { 
        ...
        redirect('dashboard_receptionist/sms/sms/new_sms');
    }  
    ...
    { 
        ...
        #pagination starts
        #
        $config["base_url"] = base_url('dashboard_receptionist/sms/sms/sms_list');
        ...
        $data['content'] = $this->load->view('dashboard_receptionist/sms/list', $data, true);
        $data['count']    = $this->dashboard_model->getAlertCount(); 
