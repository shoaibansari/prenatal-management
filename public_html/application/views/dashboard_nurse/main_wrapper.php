                    ...
                    <ul class="sidebar-menu"> 
                        ...
                        <li class="treeview <?php echo (($this->uri->segment(2) == "patient") ? "active" : null) ?>">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="<?php echo base_url("dashboard_nurse/patient/patient/create") ?>"><?php echo display('add_patient') ?></a></li>
                                <li><a href="<?php echo base_url("dashboard_nurse/patient/patient") ?>"><?php echo display('patient_list') ?></a></li> 

                                <li><a href="<?php echo base_url("dashboard_nurse/patient/patient/document_form") ?>"><?php echo display('add_document') ?></a></li> 
                                <li><a href="<?php echo base_url("dashboard_nurse/patient/patient/document") ?>"><?php echo display('document_list') ?></a></li> 
                            </ul>
                        </li>
                        ...
                        <li class="treeview <?php echo (($this->uri->segment(2) == "schedule") ? "active" : null) ?>">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="<?php echo base_url("dashboard_nurse/schedule/schedule/create") ?>"><?php echo display('add_schedule') ?></a></li>
                                <li><a href="<?php echo base_url("dashboard_nurse/schedule/schedule") ?>"><?php echo display('schedule_list') ?></a></li> 
                            </ul>
                        </li>
                        ...
                        <li class="treeview <?php echo (($this->uri->segment(2) == "appointment" || $this->uri->segment(2) == "report") ? "active" : null) ?>">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="<?php echo base_url("dashboard_nurse/appointment/appointment/create") ?>"><?php echo display('add_appointment') ?></a></li>
                                <li><a href="<?php echo base_url("dashboard_nurse/appointment/appointment") ?>"><?php echo display('appointment_list') ?></a></li> 
                                <li><a href="<?php echo base_url("dashboard_nurse/appointment/report/assign_to_me") ?>"> <?php echo display('assign_to_me') ?></a></li> 
                                <li><a href="<?php echo base_url("dashboard_nurse/appointment/report/assign_by_me") ?>"> <?php echo display('assign_by_me') ?> </a></li>
                            </ul>
                        </li>
                        ...
                        <li class="treeview <?php echo (($this->uri->segment(2) == "prescription") ? "active" : null) ?>">
                            ...
                            <ul class="treeview-menu"> 
                                <li><a href="<?php echo base_url("dashboard_nurse/prescription/case_study/create") ?>"><?php echo display('add_patient_case_study') ?></a></li>
                                <li><a href="<?php echo base_url("dashboard_nurse/prescription/case_study") ?>"><?php echo display('patient_case_study_list') ?></a></li> 
                                <li><a href="<?php echo base_url("dashboard_nurse/prescription/prescription/create") ?>"><?php echo display('add_prescription') ?></a></li>
                                <li><a href="<?php echo base_url("dashboard_nurse/prescription/prescription") ?>"><?php echo display('prescription_list') ?></a></li> 
                            </ul>
                        </li>
