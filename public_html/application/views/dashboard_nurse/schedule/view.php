                        ...
                        <?php if (!empty($schedules)) { ?>
                            ...
                            <?php foreach ($schedules as $schedule) { ?>
                                <tr>
                                    ...
                                    <td class="center">
                                        <a href="<?php echo base_url("dashboard_nurse/schedule/schedule/edit/$schedule->schedule_id") ?>" class="btn btn-xs block btn-primary"><i class="fa fa-edit"></i></a> 
                                        <a href="<?php echo base_url("dashboard_nurse/schedule/schedule/delete/$schedule->schedule_id") ?>" onclick="return confirm('<?php echo display('are_you_sure') ?>')" class="btn btn-xs block btn-danger"><i class="fa fa-trash"></i></a> 
                                    </td>
                                </tr>
                                <?php $sl++; ?>
                            <?php } ?> 
