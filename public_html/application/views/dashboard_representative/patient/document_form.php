    ...
    <div class="col-sm-12">
        <div  class="panel panel-default thumbnail"> 
            ...
            <div class="panel-heading">
                <div class="btn-group">
                    <a class="btn btn-success" href="<?php echo base_url("dashboard_representative/patient/patient/document") ?>"> <i class="fa fa-list"></i>  <?php echo display('document_list') ?> </a>  
                </div>
            </div>
            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?php echo form_open_multipart('dashboard_representative/patient/patient/document_form','class="form-inner" id="mailForm" ') ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input type="file" name="attach_file" id="attach_file">file size 3MB
...
$(function(){
    ...
    browseFile.on('change',function(e)
    {
        ...
        $.ajax({
            url      : '<?php echo base_url('dashboard_representative/patient/patient/do_upload') ?>',
