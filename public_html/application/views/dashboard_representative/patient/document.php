    ...
    <div class="col-sm-12">
        <div class="panel panel-default thumbnail">
            ...
            <div class="panel-heading">
                <div class="btn-group">
                    <a class="btn btn-success" href="<?php echo base_url("dashboard_representative/patient/patient/document_form") ?>"> <i class="fa fa-plus"></i>  <?php echo display('add_document') ?> </a>  
                </div>
            </div>
                            ...
                            <?php foreach ($documents as $document) { ?>
                                <tr>
                                    ...
                                    <td class="center" width="80">
                                        ...
                                        <a href="<?php echo base_url("dashboard_representative/patient/patient/document_delete/$document->id?file=$document->hidden_attach_file") ?>" class="btn btn-xs btn-danger" onclick="return confirm('<?php echo display('are_you_sure') ?>') "><i class="fa fa-trash"></i></a> 
                                    </td>
                                </tr>
                                <?php $sl++; ?>
                            <?php } ?> 
