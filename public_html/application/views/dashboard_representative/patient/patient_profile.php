                                            ...
                                            <?php foreach ($documents as $document) { ?>
                                                <tr>
                                                    ...
                                                    <td class="center no-print" width="110">
                                                        ...
                                                        <a href="<?php echo base_url("dashboard_representative/patient/patient/document_form/$document->patient_id") ?>" class="btn btn-xs btn-warning" title="Add Document"><i class="fa fa-plus"></i></a> 
