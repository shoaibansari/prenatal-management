                    ...
                    <div class="navbar-custom-menu">
                        <ul class="nav navbar-nav">
                            ...
                            <?php 
                                ...
                                if($this->session->userdata('user_role') == 1 or $this->session->userdata('user_role') == 2 or $this->session->userdata('user_role') == 5 or $this->session->userdata('user_role') == 11 or $this->session->userdata('user_role') == 8 ){ ?>
                    ...
                    <ul class="sidebar-menu"> 
                        ...
                        <li class="treeview <?php echo (($this->uri->segment(2) == "patient") ? "active" : null) ?>">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="<?php echo base_url("dashboard_representative/patient/patient/document_form") ?>"><?php echo display('add_document') ?></a></li> 
                                <li><a href="<?php echo base_url("dashboard_representative/patient/patient/document") ?>"><?php echo display('document_list') ?></a></li> 
                            </ul>
                        </li> 
