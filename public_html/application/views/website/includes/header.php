    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li><a href="#home"><?php echo display('home') ?> <span class="sr-only">(current)</span></a></li>
                <li><a href="#about" class="page-scroll"><?php echo display('about') ?></a></li>
                <li><a href="#service" class="page-scroll"><?php echo display('service') ?></a></li>
                <li><a href="#appointment" class="page-scroll"><?php echo display('appointment') ?></a></li>
                <li><a href="#doctor" class="page-scroll"><?php echo display('doctor') ?></a></li>
                <li><a href="#department" class="page-scroll"><?php echo display('department') ?></a></li>
                <li><a href="#blog" class="page-scroll"><?php echo display('blog') ?></a></li>
                <li><a href="#contact" class="page-scroll"><?php echo display('contact') ?></a></li>
            </ul>
        </div> <!-- /.navbar-collapse --> 
    </div> <!--/.container --> 
</nav>