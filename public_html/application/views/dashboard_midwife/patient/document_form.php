    ...
    <div class="col-sm-12">
        <div  class="panel panel-default thumbnail"> 
            ...
            <div class="panel-heading">
                <div class="btn-group">
                    <a class="btn btn-success" href="<?php echo base_url("dashboard_midwife/patient/patient/document") ?>"> <i class="fa fa-list"></i>  <?php echo display('document_list') ?> </a>  
                </div>
            </div>
            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?php echo form_open_multipart('dashboard_midwife/patient/patient/document_form','class="form-inner" id="mailForm" ') ?>
...
$(function(){
    ...
    browseFile.on('change',function(e)
    {
        ...
        $.ajax({
            url      : '<?php echo base_url('dashboard_midwife/patient/patient/do_upload') ?>',
