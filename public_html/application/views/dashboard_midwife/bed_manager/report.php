    ...
    <div class="col-sm-12">
        <div  class="panel panel-default">
            <div class="panel-body"> 
                ...
                <form class="form-inline" action="<?php echo base_url('dashboard_midwife/bed_manager/report/index') ?>">
                        ...
                        <?php if (!empty($result)) { ?>
                            ...
                            <?php foreach ($result as $value) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    ...
                                    <td><a href="<?php echo base_url() ?>dashboard_midwife/bed_manager/report/details?assign_date=<?php echo $value->assign_date; ?>&bed_id=<?php echo $value->bed_id; ?>" title="Click Me!"><?php echo $value->allocated; ?></a></td>
