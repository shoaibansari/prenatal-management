    ...
    <div class="col-sm-12">
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-heading no-print">
                <div class="btn-group"> 
                    <a class="btn btn-primary" href="<?php echo base_url("dashboard_midwife/appointment/appointment/") ?>"> <i class="fa fa-list"></i>  <?php echo display('appointment_list') ?> </a>  
                </div>
            </div> 
            ...
            <div class="panel-body panel-form">
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        <?php echo form_open('dashboard_midwife/appointment/appointment/create','class="form-inner"') ?> 
...
$(document).ready(function() {
    ...
    $('#patient_id').keyup(function(){
        ...
        $.ajax({
            url  : '<?= base_url('dashboard_midwife/appointment/appointment/check_patient/') ?>',
            type : 'post',
            dataType : 'JSON',
            data : {
    ...
    $("#department_id").change(function(){
        ...
        $.ajax({
            url  : '<?= base_url('dashboard_midwife/appointment/appointment/doctor_by_department/') ?>',
            type : 'post',
            dataType : 'JSON',
            data : {
                '<?= $this->security->get_csrf_token_name(); ?>' : '<?= $this->security->get_csrf_hash(); ?>',
    ...
    $("#doctor_id").change(function(){
        ...
        $.ajax({
            url  : '<?= base_url('dashboard_midwife/appointment/appointment/schedule_day_by_doctor/') ?>',
            type : 'post',
            dataType : 'JSON',
            data : {
                '<?= $this->security->get_csrf_token_name(); ?>' : '<?= $this->security->get_csrf_hash(); ?>',
    ...
    $("#date").change(function(){
        ...
        $.ajax({
            url  : '<?= base_url('dashboard_midwife/appointment/appointment/serial_by_date/') ?>',
            type : 'post',
            dataType : 'JSON',
            data : {
                '<?= $this->security->get_csrf_token_name(); ?>' : '<?= $this->security->get_csrf_hash(); ?>',
