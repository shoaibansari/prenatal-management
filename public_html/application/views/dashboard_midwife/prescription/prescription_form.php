            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-12 col-sm-12 table-responsive">
                        <?php echo form_open('dashboard_midwife/prescription/prescription/create') ?> 
                        ...
                        <table class="table">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th>                                        
                                        <?php echo form_dropdown('doctor_id', $doctor_list, null, 'class="btn btn-sm select2" required'); ?> 
                                    </th>
                                </tr>
                            </thead>
                        </table>
