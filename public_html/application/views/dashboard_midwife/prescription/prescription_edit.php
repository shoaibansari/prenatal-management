    ...
    <div class="col-sm-12">
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-heading no-print">
                <div class="btn-group"> 
                    <a class="btn btn-primary" href="<?php echo base_url("dashboard_midwife/prescription/prescription") ?>"> <i class="fa fa-list"></i>  <?php echo display('prescription_list') ?> </a>  
                </div>
            </div> 
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-12 col-sm-12 table-responsive">
                        <?php echo form_open('dashboard_midwife/prescription/prescription/edit/'. $prescription->id) ?> 
                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th>
                                     ...
                                     <th>                                        
                                        <?php echo form_dropdown('doctor_id', $doctor_list, $prescription->doctor_id, 'class="btn btn-sm select2" required'); ?> 
                                    </th>
                                </tr>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="<?php echo base_url("dashboard_midwife/prescription/case_study/create") ?>" class="btn btn-primary"><?php echo display('add_patient_case_study') ?></a>
      </div>
    </div>
  </div>
</div>
...
$(document).ready(function() {   
    ...
    $('body').on("click", ".caseStudyBtn", function () {
        ...
        $.ajax({
            url     : '<?php echo base_url('dashboard_midwife/prescription/prescription/case_study') ?>',
            method  : 'post',
            dataType: 'json', 
            data    : {
    ...
    $('body').on('keyup change load', '#patient_id', function() {
        ...
        $.ajax({
            url     : '<?php echo base_url('dashboard_midwife/prescription/prescription/patient') ?>',
            method  : 'post',
            dataType: 'json', 
            data    : {
                'patient_id' : patient_id,
