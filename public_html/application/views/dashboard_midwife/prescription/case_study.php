    ...
    <div class="col-sm-12">
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-heading no-print">
                <div class="btn-group"> 
                    <a class="btn btn-success" href="<?php echo base_url("dashboard_midwife/prescription/case_study/create") ?>"> <i class="fa fa-plus"></i>  <?php echo display('add_patient_case_study') ?> </a>  
                </div>
            </div>
                        ...
                        <?php if (!empty($case_studys)) { ?>
                            ...
                            <?php foreach ($case_studys as $case_study) { ?>
                                <tr>
                                    ...
                                    <td class="center">
                                        <a href="<?php echo base_url("dashboard_midwife/prescription/case_study/edit/$case_study->id") ?>" class="btn btn-xs  btn-primary"><i class="fa fa-edit"></i></a> 
                                        <a href="<?php echo base_url("dashboard_midwife/prescription/case_study/delete/$case_study->id") ?>" onclick="return confirm('<?php echo display("are_you_sure") ?>')" class="btn btn-xs  btn-danger"><i class="fa fa-trash"></i></a> 
                                    </td>
                                </tr>
                                <?php $sl++; ?>
                            <?php } ?> 
